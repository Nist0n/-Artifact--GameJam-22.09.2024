	...
	SubShader
	{
		/*ase_subshader_options:Name=Additional Options
			Option:Workflow:Specular,Metallic,BlinnPhong,Lambert:Metallic
				...
				Specular:RemoveDefine:_SPECULAR_COLOR 1
				...
				Metallic:RemoveDefine:_SPECULAR_COLOR 1
				...
				BlinnPhong:SetDefine:_SPECULAR_COLOR 1
				...
				Lambert:RemoveDefine:_SPECULAR_COLOR 1
