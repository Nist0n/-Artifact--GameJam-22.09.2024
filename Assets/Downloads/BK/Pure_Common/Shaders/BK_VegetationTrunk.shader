	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_LayerAlbedoMap = input.ase_texcoord9.xy * _LayerAlbedoMap_ST.xy + _LayerAlbedoMap_ST.zw;
				...
				float2 uv_LayerNormalMap = input.ase_texcoord9.xy * _LayerNormalMap_ST.xy + _LayerNormalMap_ST.zw;
				...
				float2 uv_MetallicROcclusionGSmoothnessA = input.ase_texcoord9.xy * _MetallicROcclusionGSmoothnessA_ST.xy + _MetallicROcclusionGSmoothnessA_ST.zw;
				float4 tex2DNode7 = tex2D( _MetallicROcclusionGSmoothnessA, uv_MetallicROcclusionGSmoothnessA );
				float2 uv_DetailMetallicGlossMap = input.ase_texcoord9.xy * _DetailMetallicGlossMap_ST.xy + _DetailMetallicGlossMap_ST.zw;
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float2 uv_LayerAlbedoMap = input.ase_texcoord4.xy * _LayerAlbedoMap_ST.xy + _LayerAlbedoMap_ST.zw;
				float2 uv_BumpMap = input.ase_texcoord4.xy * _BumpMap_ST.xy + _BumpMap_ST.zw;
				float3 unpack3 = UnpackNormalScale( tex2D( _BumpMap, uv_BumpMap ), _NormalPower );
				unpack3.z = lerp( 1, unpack3.z, saturate(_NormalPower) );
				float3 tex2DNode3 = unpack3;
				float2 uv_LayerNormalMap = input.ase_texcoord4.xy * _LayerNormalMap_ST.xy + _LayerNormalMap_ST.zw;
				float3 unpack137 = UnpackNormalScale( tex2D( _LayerNormalMap, uv_LayerNormalMap ), _2ndNormalPower );
				unpack137.z = lerp( 1, unpack137.z, saturate(_2ndNormalPower) );
				float3 tex2DNode137 = unpack137;
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float2 uv_LayerAlbedoMap = input.ase_texcoord2.xy * _LayerAlbedoMap_ST.xy + _LayerAlbedoMap_ST.zw;
				float2 uv_BumpMap = input.ase_texcoord2.xy * _BumpMap_ST.xy + _BumpMap_ST.zw;
				float3 unpack3 = UnpackNormalScale( tex2D( _BumpMap, uv_BumpMap ), _NormalPower );
				unpack3.z = lerp( 1, unpack3.z, saturate(_NormalPower) );
				float3 tex2DNode3 = unpack3;
				float2 uv_LayerNormalMap = input.ase_texcoord2.xy * _LayerNormalMap_ST.xy + _LayerNormalMap_ST.zw;
				float3 unpack137 = UnpackNormalScale( tex2D( _LayerNormalMap, uv_LayerNormalMap ), _2ndNormalPower );
				unpack137.z = lerp( 1, unpack137.z, saturate(_2ndNormalPower) );
				float3 tex2DNode137 = unpack137;
		...
		Pass
		{
						 ...
						 )
			{
				...
				unpack3.z = lerp( 1, unpack3.z, saturate(_NormalPower) );
				float3 tex2DNode3 = unpack3;
				float2 uv_LayerNormalMap = input.ase_texcoord5.xy * _LayerNormalMap_ST.xy + _LayerNormalMap_ST.zw;
				float3 unpack137 = UnpackNormalScale( tex2D( _LayerNormalMap, uv_LayerNormalMap ), _2ndNormalPower );
				unpack137.z = lerp( 1, unpack137.z, saturate(_2ndNormalPower) );
				float3 tex2DNode137 = unpack137;
...
Node;AmplifyShaderEditor.RangedFloatNode;128;-2816,1344;Inherit;False;Global;WindPower;Wind Power;22;0;Create;True;0;0;0;False;0;False;0.01;0.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;261;-2816,1600;Inherit;False;BK_Wind;-1;;1;4af8ddaf9dd38fe448a285c0087001a4;0;0;2;FLOAT3;56;FLOAT;57
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;272;192,-1565;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;MotionVectors;0;10;MotionVectors;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;False;False;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=MotionVectors;False;False;0;;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=286C9420FC72D02CCC86E0CCE64FFB7FD8AF5182